...
import { selectAllProducts, fetchProductsByFilterAsync, selectTotalItems, selectCategories, fetchCategoriesAsync } from '../ProductListSlice';
                            ...
                            <section aria-labelledby="products-heading" className="pb-24 pt-6">
                                ...
                                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
                                    ...
                                    <div className="lg:col-span-3" >
                                        ...
                                        <ProductGrid products={products} handleCart={handleCart}></ProductGrid>
                                    </div>
                                </div>
                            </section>
            ...
            {filters.map((category, index) => (
                ...
                >
                    <img
                        ...
                        style={{ borderRadius: '10%' }} // Ensure the image inside is also circular
                    />
                </button>
            ))}
        </Carousel>
                              ...
                              <div className="box-up">
                                ...
                                <div className="img-info">
                                  <div className="info-inner">
                                    ...
                                    <span className="p-company"> <StarIcon className="w-6 h-6 inline"></StarIcon> {product.rating}</span>
                                  </div>
